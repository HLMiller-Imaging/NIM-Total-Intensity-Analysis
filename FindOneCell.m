function [Threshold]=FindOneCell(CellAreas)
%FINDONECELL
...
%
% Example code
% [BW25113dmscLSeredsOneCellThreshold]=FindOneCell(BW25113dmscLSereds(:,8));
%
% Helen Miller April 2021

%% plot the data and use find peaks to find the tallest peak
figure; 
[dens1,x1]=ksdensity(CellAreas,0:5:700);
...
opts.StartPoint = [0.005 OneCellPeak 50];
